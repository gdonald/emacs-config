...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (slime company ag company-inf-ruby color-theme-modern rspec-mode projectile flycheck-perl6 flymake-haml flymake-json flymake-ruby flymake-sass flymake-yaml haml-mode perl6-mode smartparens web-mode company-emoji emojify projectile-rails)))
